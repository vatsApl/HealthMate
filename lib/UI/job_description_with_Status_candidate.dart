...
class jobDescriptionWithStatusCandidate extends StatefulWidget {
  ...
  jobDescriptionWithStatusCandidate(
      {super.key, this.jobId, this.appId, this.currentIndex});
  @override
...
class _jobDescriptionWithStatusCandidateState
    extends State<jobDescriptionWithStatusCandidate> {
  JobModel? jobDesc;
  int? timeSheetId;
  double? lat;
  double? long;
        ...
        if (response.statusCode == 200) {
          ...
          setState(() {
            Navigator.push(
              context,
              MaterialPageRoute(
                builder: (context) => SignOffPageAfterDispute(timeSheetId: timeSheetId, signOffData: jobDesc),
              ),
            );
          });
        }
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text('${jobDesc?.candidateWorkingStatus}'.toUpperCase(),
                      style: TextStyle(
                        fontSize: 12.0,
                        fontWeight: FontWeight.w500,
                        color: candidateWorkingStatus == 'Payment Due' //color change with candidate Working Status
                            ? kredColor
                      ...
                      children: [
                        ...
                        Expanded(
                          child: Align(
                            ...
                            child: Text('${jobDesc?.candidateWorkingStatus}'.toUpperCase(),
                              style: TextStyle(
                                fontSize: 12.0,
                                fontWeight: FontWeight.w500,
